...
describe('Check primalty', function () {
    describe('', function () {
        ...
        context('Errores de fecha', function () {
            ...
            it('should return DATE_ERROR for "01jan1969"', function () {
                calculateDaysSinceEpoch("01jan1969").should.equal(FORMAT_DATE);
            });
        });
        context('Fechas correctas', function () {
            ...
            it('Should return 16717 for "09oct2015"', function () {
                calculateDaysSinceEpoch("09oct2015").should.be.equal(16717);
            });
            it('Should return 0 for "01jan1970"', function () {
                calculateDaysSinceEpoch("01jan1970").should.be.equal(0);
            });
        });
    });
});