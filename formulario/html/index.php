    ...
    <body>
        <main>
            ...
            <?php
                ...
                if (!isset($_COOKIE['cookies']) && $_SESSION['cookie'] !== "") {
                    echo "<h1>FORMULARIO DE COOKIES</h1>";
                    echo "<form action='index.php' method='POST'>";
                    echo "¿Aceptas las cookies?";
                    echo "<input type='submit' name='accept' value='Aceptar' />";
                    echo "<input type='submit' name='reject' value='Rechazar' />";
                    echo "</form>";
                }
            ?>
